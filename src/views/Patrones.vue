...
export default {
  ...
  data() {
    return {
      ...
      dropdown: { height: 0 },
      rating: { min: 10, max: 0 },
      filters: { countries: {}, categories: {}, slogans:{}, rating: 0 },
      menus: { countries: false, categories: false, slogans:false, rating: false }
    }
  },
  ...
  beforeMount() {
    fetch('https://s3-us-west-2.amazonaws.com/s.cdpn.io/450744/mock-data.json')
      ...
      .then(companies => {
        ...
        companies.forEach(({ country, keywords, slogan, rating }) => {
          ...
          keywords.forEach(category => {
            ...
            // donde deberia ir el filtro
            this.$set(this.filters.categories, slogan, false)
          })
        })
      })
  }
